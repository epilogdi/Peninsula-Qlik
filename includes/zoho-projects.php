...
function getNewZohoToken(){
  ...
  global $ENV_ZOHO_PROJECTS_REFRESH_TOKEN;
  global $ENV_ZOHO_PROJECTS_CLIENT_ID;
  global $ENV_ZOHO_PROJECTS_CLIENT_SECRET;
  ...
  $options = [
    "form_params" => [
      "refresh_token" => "$ENV_ZOHO_PROJECTS_REFRESH_TOKEN",
      "client_id" => "$ENV_ZOHO_PROJECTS_CLIENT_ID",
      "client_secret" => "$ENV_ZOHO_PROJECTS_CLIENT_SECRET", 
